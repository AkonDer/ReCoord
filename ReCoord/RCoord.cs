...
namespace ReCoord
{
    ...
    public class RCoord
    {
        ...
        /// <param name="al">Угол направления стрельбы</param>
        ...
        public double GetAlf
        {
            get
            {
                double dx = GetXtr - Xst; // разница координат станции и точки упреждения - катет
                double dy = GetYtr - Yst; // разница координат станции и точки упреждения - катет
        ...
        public double getDnakl
        {
            ...
            {
                double H = Hop - Hst + dYtr; // высота точки упреждения от станции
                double dx = GetXtr - Xst; // разница координат станции и точки упреждения катеты
                double dy = GetYtr - Yst; // разница координат станции и точки упреждения катеты
        ...
        /// <summary>
        /// Получение координаты Х траектории в топографических координатах
        /// </summary>
        ...
        /// <summary>
        /// Получение координаты Y траектории в топографических координатах
        /// </summary>
        public double GetYtr
        {
            get
            {
                return Yop + dXtr * Math.Sin(alf * Math.PI / 180);  
            }
        }
        ...
        /// <summary>
        /// Метод берет угол в градусах и возвращает в делениях уголомера в виде оформленной строки
        /// </summary>
        /// <param name="a">Угол в градусах</param>
