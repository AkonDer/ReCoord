...
namespace ReCoord
{
    class RCoord
    {
        ...
        // функция возвращает наклонную дальность
        private double Dl()
        {
            double H = Hop - Hst + dYtr; // высота точки упреждения от станции
            ...
            double D = Math.Sqrt(H * H + X * X); // наклонная дальность высчетаная по формуле сумма квадратов катетов равна квадрату гипотенузы
            return D;
        }
    }
}
